...
call jhpcndf_open_(unit, ufile//null, lfile//null, action//null)
...
real(4)           :: data(:)
character(len=1), parameter  :: null = char(0)
call jhpcndf_write_real4_(unit, recl, data, tol, enc//null, comp//null)
...
real(8)           :: data(:)
character(len=1), parameter  :: null = char(0)
call jhpcndf_write_real8_(unit, recl, data, tol, enc//null, comp//null)
...
subroutine jhpcndf_encode_real4(length, src, dst, dst_lower, tol, enc)
implicit none
integer(8)        :: length
real(4)           :: src(:)
real(4)           :: dst(:)
...
character(len=*)  :: enc
character(len=1), parameter  :: null = char(0)
call jhpcndf_encode_real4_(length, src, dst, dst_lower, tol, enc//null)
end subroutine jhpcndf_encode_real4

subroutine jhpcndf_encode_real8(length, src, dst, dst_lower, tol, enc)
implicit none
integer(8)        :: length
real(8)           :: src(:)
real(8)           :: dst(:)
...
character(len=*)  :: enc
character(len=1), parameter  :: null = char(0)
call jhpcndf_encode_real8_(length, src, dst, dst_lower, tol, enc//null)
